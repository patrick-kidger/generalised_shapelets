...
def main(_run,
    ...
    _run.log_scalar(max(validation_history['acc.test']), 'acc.test.best')
...
if __name__ == '__main__':
    config = {
        ...
        'ds_name': ['SonyAIBORobotSurface1', 'Coffee', 'MoteStrain', 'Chinatown', 'ECGFiveDays'],
        'multivariate': [False],
        'path_tfm': ['signature'],
        'aug_list': [['addtime']],

        'num_shapelets': [8 for i in range(10)],
        'num_window_sizes': [10],
        'min_window': [5],
        'max_window': [200],
        'depth': [3],
